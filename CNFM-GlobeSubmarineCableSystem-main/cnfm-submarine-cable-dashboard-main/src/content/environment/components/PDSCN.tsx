...
const SEGMENTS: SegmentData[] = [
  { id: 'S1', label: 'S1 | Ilijan - Pinamalayan', start: 'Ilijan', end: 'Pinamalayan', endpoint: '/ilijan_pinamalayan' },
  { id: 'S2', label: 'S2 | Pinamalayan - Boracay', start: 'Pinamalayan', end: 'Boracay', endpoint: '/pinamalayan_boracay' },
  { id: 'S3', label: 'S3 | Lucena - Boac', start: 'Lucena', end: 'Boac', endpoint: '/lucena_boac' },
  { id: 'S4', label: 'S4 | Boac - Calatrava', start: 'Boac', end: 'Calatrava', endpoint: '/boac_calatrava' },
  { id: 'S5', label: 'S5 | Calatrava - Roxas', start: 'Calatrava', end: 'Roxas', endpoint: '/calatrava_roxas' },
  { id: 'S6', label: 'S6 | Roxas - Placer', start: 'Roxas', end: 'Placer', endpoint: '/roxas_placer' },
  { id: 'S7', label: 'S7 | Iloilo - Bacolod', start: 'Iloilo', end: 'Bacolod', endpoint: '/iloilo_bacolod' },
  { id: 'S8', label: 'S8 | San Carlos - Toledo', start: 'San Carlos', end: 'Toledo', endpoint: '/san_carlos_toledo' },
  { id: 'S9', label: 'S9 | Zamboanguita - Dipolog', start: 'Zamboanguita', end: 'Dipolog', endpoint: '/zamboanguita_dipolog' },
  { id: 'S10', label: 'S10 | Mactan - Palompon', start: 'Mactan', end: 'Palompon', endpoint: '/mactan_palompon' },
  { id: 'S11', label: 'S11 | Caticlan - Boracay', start: 'Caticlan', end: 'Boracay', endpoint: '/caticlan_boracay' },
  { id: 'S12', label: 'S12 | Placer - Palompon', start: 'Placer', end: 'Palompon', endpoint: '/placer_palompon' },
  { id: 'S13', label: 'S13 | Talisay - Tagbilaran', start: 'Talisay', end: 'Tagbilaran', endpoint: '/talisay_tagbilaran'},
  { id: 'S14', label: 'S14 | Baclayon - CDO', start: 'Baclayon', end: 'CDO', endpoint: '/baclayon_cdo' },
  { id: 'S15', label: 'S15 | Dipolog - CDO', start: 'Dipolog', end: 'CDO', endpoint: '/dipolog_cdo' },
  { id: 'S16', label: 'S16 | Maasin - Surigao', start: 'Maasin', end: 'Surigao', endpoint: '/maasin_surigao' },
  { id: 'S17', label: 'S17 | Calbayog - Palanas', start: 'Calbayog', end: 'Palanas', endpoint: '/calbayog_palanas' },
  { id: 'S18', label: 'S18 | Bulan - Palanas', start: 'Bulan', end: 'Palanas', endpoint: '/bulan_palanas' },
  { id: 'S19', label: 'S19 | Siargao - Claver', start: 'Siargao', end: 'Claver', endpoint: '/siargao_claver' },
  { id: 'S20', label: 'S20 | Kinoguitan - Camiguin', start: 'Kinoguitan', end: 'Camiguin', endpoint: '/kinoguitan_camiguin' },
  { id: 'S21', label: 'S21 | Liloy - Dipolog', start: 'Liloy', end: 'Dipolog', endpoint: '/liloy_dipolog' },
  { id: 'S22', label: 'S22 | Mactan - Maasin', start: 'Mactan', end: 'Maasin', endpoint: '/mactan_maasin' },
  { id: 'S23', label: 'S23 | Zamboanga - Liloy', start: 'Zamboanga', end: 'Liloy', endpoint: '/liloy_zamboanga' },
];
...
function Fobn1Dialog({ open, onClose }: Fobn1DialogProps) {
  ...
  return (
    <Dialog open={open} onClose={handleCloseDialog} maxWidth="sm" fullWidth>
      <DialogTitle sx={{ mt: 2 }}>
        <Typography variant="h5">Simulate PDSCN Cable Fault</Typography>
      </DialogTitle>
      <Divider />
